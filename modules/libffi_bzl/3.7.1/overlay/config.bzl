...
FFI_H_BY_WINDOWS_CPU = {
    ...
    "//platforms:x86_windows": {
        "@TARGET@": "X86_WIN32",
        "@HAVE_LONG_DOUBLE@": "0",
    },
    "//platforms:arm64_windows": {
        "@TARGET@": "ARM_WIN64",
        "@HAVE_LONG_DOUBLE@": "0",
    },
    "//platforms:arm32_windows": {
        "@TARGET@": "ARM_WIN32",
        "@HAVE_LONG_DOUBLE@": "0",
    },
    "//conditions:default": {},
...
FFICONFIG_WINDOWS_32BIT = {
    ("//platforms:x86_windows", "//platforms:arm32_windows"): _macros({
        "SYMBOL_UNDERSCORE": "1",
    }),
    "//conditions:default": {},
}
